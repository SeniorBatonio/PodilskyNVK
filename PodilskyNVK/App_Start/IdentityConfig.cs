...
namespace PodilskyNVK
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Код, отриманий за телефоном", new PhoneNumberTokenProvider<ApplicationUser>
            {
    ...
    public class CustomPasswordValidator : IIdentityValidator<string>
    {
        public Task<IdentityResult> ValidateAsync(string item)
        {
            ...
            if (!Regex.IsMatch(item, @"[a-zA-Z]") || !Regex.IsMatch(item, @"\d"))
            {
                return Task.FromResult(IdentityResult.Failed("Пароль має містити цифри(0-9) та букви(A-Z, a-z)."));
            }
